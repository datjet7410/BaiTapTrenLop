 ...
 int led_state = 1;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(led_state_1>=4) led_state_1=0;
	  HAL_Delay(1000);
  }
  /* USER CODE END 3 */
}
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, B_Pin|A_Pin|A1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(B1_GPIO_Port, B1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : B_Pin A_Pin A1_Pin */
  GPIO_InitStruct.Pin = B_Pin|A_Pin|A1_Pin;
